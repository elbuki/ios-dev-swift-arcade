...
extension SkeletonCell {
    ...
    private func setupLayers() {
        ...
        typeLayer.startPoint = startPoint
        typeLayer.endPoint = endPoint
        typeLabel.layer.addSublayer(typeLayer)
        
        nameLayer.startPoint = startPoint
        nameLayer.endPoint = endPoint
        nameLabel.layer.addSublayer(nameLayer)
        
        balanceLayer.startPoint = startPoint
        balanceLayer.endPoint = endPoint
        balanceLabel.layer.addSublayer(balanceLayer)
        
        balanceAmountLayer.startPoint = startPoint
        balanceAmountLayer.endPoint = endPoint
    ...
    private func setupAnimation() {
        ...
        typeLayer.add(typeGroup, forKey: key)
        ...
        balanceLayer.add(balanceGroup, forKey: key)
        
        let balanceAmountGroup = makeAnimationGroup(previousGroup: balanceGroup)
        balanceAmountLayer.add(balanceAmountGroup, forKey: key)
    }
